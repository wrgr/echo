  ...
  return (
    <div style={styles.helpContainer}>
      <div style={styles.section}>
        <h3 style={styles.sectionTitle}>Ask SUSAN for Advice</h3>
        ...
        <p style={styles.label}>Your Question for SUSAN (e.g., "How can I better elicit their concerns?", "What's a good way to introduce an interpreter?"):</p>
        <textarea
          style={styles.textArea}
          value={question}
      ...
      {advice && (
        <div style={styles.section}>
          <h3 style={styles.sectionTitle}>SUSAN's Advice</h3>
